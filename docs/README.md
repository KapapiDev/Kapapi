...
- [LEGAL.md](./LEGAL.md) — legal/product boundaries, payment/security/IP/professional-service risk
- [DECISIONS.md](./DECISIONS.md) — durable decisions and why they were made

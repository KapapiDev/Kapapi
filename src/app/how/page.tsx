  ...
  return (
    <div className={`frame ${s.wrap}`}>
      <div className={s.head}>
        <h1 className={s.title}>업무 하나가 끝나는 과정</h1>
        <p className={s.sub}>일이 먼저 올라오고, 맞는 작업자가 가격과 완료시간을 제안합니다. 지금 단계에서는 카파피 추천을 확인한 뒤 발주자가 작업자를 확정합니다.</p>
      </div>
      ...
      <div className={s.grid}>
        <div className={s.stack}>
          ...
          <section>
            <div className={s.panelHead}>
              <h2 className={s.panelTitle}>2. 가격 × 완료시간 제안</h2>
              <span className={s.panelEn}>제안 비교</span>
            </div>
          ...
          <section>
            <div className={s.panelHead}>
              <h2 className={s.panelTitle}>3. 카파피가 추천하고, 발주자가 확정합니다</h2>
            ...
            <div className={s.card}>
              ...
              <p className={s.note}>가장 싸거나 가장 빠르다는 이유만으로 고르지 않습니다. 추천 근거를 보고 발주자가 확정합니다.</p>
            </div>
          </section>
          ...
          <section>
            <div className={s.panelHead}>
              ...
              <span className={s.panelEn}>결과</span>
            </div>
            {q.result ? (
          ...
          <section>
            <div className={s.panelHead}>
              ...
              <span className={s.panelEn}>성장 경로</span>
            </div>
            <div className={s.card}>
              <p className={s.note}>완료, 정시, 수정, 실패와 복구 이력이 쌓이면 카파피가 선택을 더 잘 도울 수 있습니다. 충분히 검증된 업무부터 추천 → 기본 배정 → 복구 → 업무 실행 레이어로 발전합니다.</p>
            </div>
          </section>
        </div>
        ...
        <aside className={s.aside}>
          <div className={s.card}>
            <p className={s.cardTitle}>발주자</p>
            <div className={s.list}>
              <p className={s.item}><span className={s.mark} aria-hidden="true">1</span>업무와 자료를 등록합니다</p>
              <p className={s.item}><span className={s.mark} aria-hidden="true">2</span>정리된 작업 조건을 확인합니다</p>
              <p className={s.item}><span className={s.mark} aria-hidden="true">3</span>카파피 추천을 확인하고 작업자를 확정합니다</p>
              <p className={s.item}><span className={s.mark} aria-hidden="true">4</span>결과를 확인하거나 수정 요청합니다</p>
            </div>
          </div>
          <div className={s.card}>
            <p className={s.cardTitle}>작업자</p>
            <div className={s.list}>
          ...
          <div className={s.acts}>
            <Link href="/" className={`${s.btn} ${s.btnAccent}`}>업무 등록하기</Link>

    ...
    return (
      <div className={`frame ${s.confirm}`}>
        ...
        <p className={s.confirmBody}>
          전문가를 찾고 조건을 확인하는 과정은 카파피가 진행합니다.
  ...
  return (
    <div className={`frame ${s.wrap}`}>
      ...
      <div className={s.head}>
        ...
        <p className={s.sub}>여기서 한 번만 확인하면, 이후 과정은 카파피가 진행합니다.</p>
      </div>
      ...
      <div className={s.sheet}>
        ...
        <div className={s.pairGrid}>
          <div className={s.half}>
            ...
            <p className={s.hint} style={{ marginTop: 6 }}>마감을 넘기는 제안은 배정 대상에서 제외됩니다.</p>
          </div>
          <div className={s.half}>
            ...
            <p className={s.hint} style={{ marginTop: 6 }}>이 금액을 넘는 제안은 배정하지 않습니다. 금액은 제안한 사람이 정합니다.</p>
          </div>
        </div>

        {resolved ? (
          <div className={s.block}>
            <p className={s.item} style={{ color: "var(--ok)" }}><span aria-hidden="true">✓</span> 배정에 필요한 정보가 모두 확인되었습니다</p>
          </div>
        ) : (
        ...
        <div className={s.submitBar}>
          ...
          <p className={s.hint} style={{ maxWidth: "42ch" }}>
            등록하면 자격을 갖춘 전문가에게 공개되고, 배정까지 카파피가 진행합니다.
          </p>
        </div>
      </div>
    </div>
